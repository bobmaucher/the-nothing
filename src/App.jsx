      ...
      <section className="relative overflow-hidden border-b border-white/10 text-slate-100">
        <div className="max-w-7xl mx-auto px-4 py-28">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <NeonButton onClick={payOnce}><span className="inline-flex items-center gap-2"><CreditCard className="w-4 h-4"/> Buy Nothing (one‑time)</span></NeonButton>
            <NeonButton variant="ghost" onClick={subscribe}>Subscribe to Nothing (monthly)</NeonButton>
          </div>
